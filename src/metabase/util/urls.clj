...
(defn pulse-url
  ...
  [^Integer id]
  (format "%s/metabase/pulse#%d" (setting/get :-site-url) id))
...
(defn dashboard-url
  ...
  [^Integer id]
  (format "%s/metabase/dash/%d" (setting/get :-site-url) id))
...
(defn card-url
  ...
  [^Integer id]
  (format "%s/metabase/card/%d" (setting/get :-site-url) id))
...
(defn segment-url
  ...
  [^Integer id]
  (format "%s/metabase/admin/datamodel/segment/%d" (setting/get :-site-url) id))

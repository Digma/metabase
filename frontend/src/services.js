...
CoreServices.factory('Card', ['$resource', '$cookies', function($resource, $cookies) {
    return $resource('/metabase/api/card/:cardId', {}, {
        list: {
            url: '/metabase/api/card/?f=:filterMode',
            method: 'GET',
            isArray: true
        },
        create: {
...
CoreServices.factory('Dashboard', ['$resource', '$cookies', function($resource, $cookies) {
    return $resource('/metabase/api/dashboard/:dashId', {}, {
        list: {
            url:'/metabase/api/dashboard?f=:filterMode',
            method:'GET',
            isArray:true
        },
        create: {
...
CoreServices.factory('ForeignKey', ['$resource', '$cookies', function($resource, $cookies) {
    return $resource('/metabase/api/foreignkey/:fkID', {}, {
        delete: {
            method: 'DELETE',
            params: {
                fkID: '@fkID'
...
CoreServices.factory('Metabase', ['$resource', '$cookies', 'MetabaseCore', function($resource, $cookies, MetabaseCore) {
    return $resource('/metabase/api/meta', {}, {
        ...
        field_foreignkeys: {
            url: '/metabase/api/field/:fieldId/foreignkeys',
            method: 'GET',
            params: {
                fieldId: '@fieldId'
            },

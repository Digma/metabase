        ...
        return (
            <nav className="CheckBg CheckBg-offset relative bg-brand sm-py2 sm-py1 xl-py3">
                <ul className="pl4 pr1 flex align-center">
                    ...
                    <li className="pl1">
                        <a data-metabase-event={"Navbar;Questions"} style={this.styles.navButton} className={cx("NavItem cursor-pointer text-white text-bold no-decoration flex align-center px2 transition-background", {"NavItem--selected": this.props.location.path() === "/metabase/card/"})} href="/metabase/card/">Questions</a>
                    </li>
                    <li className="pl1">
                        <a data-metabase-event={"Navbar;Pulses"} style={this.styles.navButton} className={cx("NavItem cursor-pointer text-white text-bold no-decoration flex align-center px2 transition-background", {"NavItem--selected": this.props.location.path() === "/metabase/pulse/"})} href="/metabase/pulse/">Pulses</a>
                    </li>
                    <li className="pl3">
